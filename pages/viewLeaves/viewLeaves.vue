  ...
  <view class="container">
    ...
    <view class="main">
      ...
      <view class="main-top-state" :style="getTopStateBackground()">
        ...
        <!-- <view class="nav-right-below">个人信息></view>
    </view> -->
      ...
      <view class="main-content">
        <view class="main-content-type">
          <view
            class="main-content-type-leaveType"
            style="position: relative; padding-left: 140rpx; width: 30%"
          >
            ...
            <text
              class="blackFont"
              style="margin-left: -20rpx; font-weight: 400"
            >
              {{ leave.type }}
            </text>
          </view>
          ...
          <view
            class="main-content-type-leaveSchool"
            style="
              position: absolute;
              left: calc(50% - 150rpx);
              font-weight: 40;
            "
          >
            需要离校：<text class="blackFont" :style="byecolor()">{{
              this.leave.bye
            }}</text>
          </view>
          ...
          <view
            class="main-content-type-clearRule"
            style="position: relative; padding-left: 130rpx"
          >
            <view style="position: absolute; top: 0px; left: 0px"
              >销假规则：</view
            >
            <view style="color: #f79a0d; margin-left: -10rpx"
              >离校请假需要销假，非离校请假无需销假
              <!-- <text style="color: #589fd5; margin-left: 5px">查看></text> -->
            </view>
          </view>
          <view
            class="main-content-type-leaveDate"
            style="position: relative; padding-left: 185rpx"
          >
            <view style="position: absolute; top: 0px; left: 0px"
              >实际休假时间：</view
            >
        ...
        <view class="main-content-info">
          ...
          <view class="main-content-info-left">
            ...
            <br />
            <view
              class="main-content-info-left-file"
              style="width: 100%"
              v-if="leave.imgFile != ''"
              ><text style="color: #9ea8b4">附件：</text
            ...
            <!-- <view style="color: #f79a0d; width: 100%"
              >本人承诺填写的信息真实有效，并对本次提交请假申请的信息真实性负责。</view
            > -->
          </view>
        </view>

        <view
          class="main-content-checkState"
          :style="leave.state == '正在休假中' ? 'margin-bottom:130px;' : ''"
        >
          <view
            class="main-content-checkState-border"
            :style="getCheckStateBorderHeight()"
          ></view>
          <view
            class="blackFont"
            style="
          ...
          <view class="main-content-checkState-state">
            <view class="main-content-checkState-state-apply">
              ...
              <view style="position: relative; top: -3px; left: 20rpx"
                >{{ leave.name }} - 发起申请</view
              >
              <view
                style="
                  position: absolute;
                  ...
                  color: #9fa7b4;
                "
                >{{ leave.applyDate }}</view
              >
            </view>

            <view class="main-content-checkState-state-checkOne">
              <view
                class="main-content-checkState-cirGreen"
              ...
              >
                <text>
                  <!-- [{{ leave.oneCheckStatus }}] -->
                  一级： {{ leave.oneCheck }} - 审批<text style="color: #00ca76"
                    >通过</text
                  ></text
                >
              </view>
              <view
                style="
                  ...
                  color: #9fa7b4;
                "
                >{{ leave.oneCheckDate }}</view
              >
              <view class="main-content-checkState-checkInfo"
                >审批意见：{{ leave.oneCheckIdea }}</view
              >
            </view>

            <view
              class="main-content-checkState-state-checkTwo"
              v-if="leave.twoCheck != ''"
            >
              <view
                class="main-content-checkState-cirGreen"
              ...
              >
                <text
                  >二级：[{{ leave.twoCheckStatus }}]{{ leave.twoCheck }} -
                  审批<text style="color: #00ca76">通过</text></text
                > </view
              ><br />
              <view
                style="
                  ...
                  color: #9fa7b4;
                "
                >{{ leave.twoCheckDate }}</view
              >
              <view class="main-content-checkState-checkInfo"
                >审批意见：{{ leave.twoCheckIdea }}</view
              >
            </view>
            <view
              class="main-content-checkState-state-checkThree"
              v-if="leave.threeCheck != ''"
            >
              <view
                class="main-content-checkState-cirGreen"
                style="position: absolute; top: 0px"
              ...
              >
                <text
                  >三级：[{{ leave.threeCheckStatus }}]{{ leave.threeCheck }} -
                  审批<text style="color: #00ca76">通过</text></text
                > </view
              ><br />
              <view
              ...
              >
              <view class="main-content-checkState-checkInfo"
                >审批意见：{{ leave.threeCheckIdea }}</view
              >
            </view>

            <view
              class="main-content-checkState-state-apply"
              style="margin-top: 10px"
              v-if="leave.state == '已完成'"
            >
              <view class="main-content-checkState-cirBlue">
                <view></view>
              </view>
              <view style="position: relative; top: -3px; left: 20rpx"
                >{{ leave.name }} - 销假成功</view
              >
              <view
                style="
                  position: absolute;
                  ...
                  color: #9fa7b4;
                "
                >{{ leave.clearDate }}</view
              >
            </view>
          </view>
        </view>
        <view class="main-content-clearInfo" v-if="leave.state == '已完成'">
          <view class="main-content-clearInfo-info"
            >销假信息
            <view
              >所在位置：<text class="blackFont">{{
                leave.address
              }}</text></view
            >
          </view>
        ...
        <view class="main-content-share-clear" v-if="leave.state == '已完成'"
          >转发</view
        >
        <view
          class="main-content-bottom-btn"
          v-if="leave.state == '正在休假中'"
        >
          <view>转发</view>
          <view>申请续假</view>
          <view style="background-color: #2f98e9; color: white" @click="clear"
            >去销假</view
          >
        </view>
      </view>
