<template>
  <view>
    ...
    <input placeholder="阿粥" v-model="name" />
    ...
    <view class="pickerView">
      <picker
        ...
        style="width: 42%; position: absolute; left: 0px"
        :value="'2020-' + startDate"
      >
        <view style="line-height: 45px; color: gray" v-if="startDate == ''"
          >开始日期（年无效）</view
        >
        <view style="line-height: 45px" v-if="startDate != ''">{{
          startDate
        }}</view>
      </picker>
      <picker
        ...
        style="width: 42%; position: absolute; right: 0px"
        :value="startTime"
      >
        <view style="line-height: 45px; color: gray" v-if="startTime == ''"
          >开始时间</view
        >
        <view style="line-height: 45px" v-if="startTime != ''">{{
          startTime
        }}</view>
      </picker>
    </view>
    ...
    <view class="pickerView">
      <picker
        ...
        :value="'2020-' + endDate"
      >
        <view style="line-height: 45px; color: gray" v-if="endDate == ''"
          >结束日期（年无效）</view
        >
        <view style="line-height: 45px" v-if="endDate != ''">{{
          endDate
        }}</view>
      </picker>
      <picker
        ...
        :value="endTime"
      >
        <view style="line-height: 45px; color: gray" v-if="endTime == ''"
          >结束时间</view
        >
        <view style="line-height: 45px" v-if="endTime != ''">{{
          endTime
        }}</view>
      </picker>
    </view>
    ...
    <input placeholder="-" v-model="dorm" />
    ...
    <view class="pickerView">
      <picker
        mode="date"
        @change="bindOneCheckDate"
        style="width: 42%; position: absolute; left: 0px"
        :value="'2020-' + oneCheckDate"
      >
        <view style="line-height: 45px; color: gray" v-if="oneCheckDate == ''"
          >审批日期（年无效）</view
        >
        <view style="line-height: 45px" v-if="oneCheckDate != ''">{{
          oneCheckDate
        }}</view>
      </picker>
      <picker
        mode="time"
        @change="bindOneCheckTime"
        style="width: 42%; position: absolute; right: 0px"
        :value="oneCheckTime"
      >
        <view style="line-height: 45px; color: gray" v-if="oneCheckTime == ''"
          >审批时间</view
        >
        <view style="line-height: 45px" v-if="oneCheckTime != ''">{{
          oneCheckTime
        }}</view>
      </picker>
    </view>
    ...
    <view class="pickerView">
      <picker
        mode="date"
        @change="bindTwoCheckDate"
        style="width: 42%; position: absolute; left: 0px"
        :value="'2020-' + twoCheckDate"
      >
        <view style="line-height: 45px; color: gray" v-if="twoCheckDate == ''"
          >审批日期（年无效）</view
        >
        <view style="line-height: 45px" v-if="twoCheckDate != ''">{{
          twoCheckDate
        }}</view>
      </picker>
      <picker
        mode="time"
        @change="bindTwoCheckTime"
        style="width: 42%; position: absolute; right: 0px"
        :value="twoCheckTime"
      >
        <view style="line-height: 45px; color: gray" v-if="twoCheckTime == ''"
          >审批时间</view
        >
        <view style="line-height: 45px" v-if="twoCheckTime != ''">{{
          twoCheckTime
        }}</view>
      </picker>
    </view>
    ...
    <view class="pickerView">
      <picker
        mode="date"
        @change="bindThreeCheckDate"
        style="width: 42%; position: absolute; left: 0px"
        :value="'2020-' + threeCheckDate"
      >
        <view style="line-height: 45px; color: gray" v-if="threeCheckDate == ''"
          >审批日期（年无效）</view
        >
        <view style="line-height: 45px" v-if="threeCheckDate != ''">{{
          threeCheckDate
        }}</view>
      </picker>
      <picker
        mode="time"
        @change="bindThreeCheckTime"
        style="width: 42%; position: absolute; right: 0px"
        :value="threeCheckTime"
      >
        <view style="line-height: 45px; color: gray" v-if="threeCheckTime == ''"
          >审批时间</view
        >
        <view style="line-height: 45px" v-if="threeCheckTime != ''">{{
          threeCheckTime
        }}</view>
      </picker>
    </view>
    ...
    <image
      src="../../static/img/other_tips.png"
      style="height: 81px; width: 257px; margin: 10px; border: 1px solid #ccc"
    ></image> -->
